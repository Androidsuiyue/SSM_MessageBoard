        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            ...
            <ul class="nav navbar-nav navbar-right">
                <c:if test="${empty currentUser}">
                    <li><a href="${cp}/registerPage" methods="post">注册</a></li>
                    <li><a href="${cp}/loginPage" methods="post">登录</a></li>
                </c:if>
                <c:if test="${not empty currentUser}">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="${cp}/login.jsp">购物车</a></li>
                            <li><a href="${cp}/login.jsp">订单状态</a></li>
                            <c:if test="${currentUser.type == 1}">
                                <li><a href="${cp}/shopping_handle">处理订单</a></li>
                            </c:if>
                            <li role="separator" class="divider"></li>
                            <li><a href="${cp}/login.jsp">个人资料修改</a></li>
