            ...
            <div class="right-content">
                ...
                <table class="tb" id="tb">
                    <tr>
                        ...
                        <td valign="top" class="tb-content" name="tb1" id="tb1">小区噪音严重影响市民健康</td>
                    </tr>
                    <tr>
                        <td valign="top" class="tb-title">作者：</td>
                        <td valign="top" class="tb-content" name="tb2" id="tb2">小小</td>
                    </tr>
                    <tr>
                        <td valign="top" class="tb-title">日期：</td>
                        <td valign="top" class="tb-content" name="tb3" id="tb3">2019-03-18</td>
                    </tr>
                    <tr style="height: 50px;">
                        <td valign="top" class="tb-title">内容：</td>
                        <td valign="top" class="tb-content" name="tb4" id="tb4">小区噪音验证影响市民健康，很是让人烦躁，你们怎么看？</td>
                    </tr>
                    <tr id="tr-content" style="height: 50px;display: none;">
                        <td valign="top" class="tb-title">内容：</td>
                        <td valign="top" class="tb-content">
                            <textarea rows="5" cols="30">小区噪音验证影响市民健康，很是让人烦躁，你们怎么看？</textarea>
                        </td>
                    </tr>
                    ...
                    <tr id="tb-content">
                        ...
                        <td valign="top" class="tb-content td-color"   name="tb5" id="tb5">已经将您的咨询转到市长信箱处理，请您留意场相关信箱。</td>
                ...
                <div class="tb" style="display: none;" id="look-content">
                        <td valign="top" class="tb-title">作者：</td>
                        <input type="text" name="user"  readonly="readonly" value="${currentUser.id}" size="40">
                    </tr>
